...
import myImg from '../assets/img/avatarFront.png'
  ...
  return (
    ...
    <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      ...
      <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6  ">
        <img className="object-cover object-center rounded-3xl border-b-purple-600 border-b-8  " alt="Developer Picture" src={myImg} width='600' />
